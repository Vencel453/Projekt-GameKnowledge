...
export default {
    // Itt a bejelentkezett felhasználó adainak a lekérést kezeljük
    ...
    MyprofilePostController: async(req, res) => {
        try {
            ...
            // Egy változóban ellenőrizzük, hogy történik-e változtatás
            let empty = true;
    ...
    MyprofileDeleteController: async(req, res) => {
        try {
            ...
            // Ha az ellenőrzéseken sikeresen átment, akkor a töröljük a felhasználót, majd visszaküldjük a megerősító választ,
